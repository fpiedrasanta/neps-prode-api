...
pipeline {
    ...
    stages {
        ...
        // Todo el despliegue se ejecuta en el agente Windows (sin SSH, sin VPN)
                            ...
                            script {
                                ...
                                powershell """
                                    ...
                                    if (Test-Path '${DEPLOY_PATH}\\${DEPLOY_SCRIPTS_PATH}\\configure-git.ps1') {
                                        ...
                                        git remote set-url origin https://${safePAT}@github.com/fpiedrasanta/prode-neps-api.git
                                    }
                                """
                            }
                        }
